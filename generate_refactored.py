#!/usr/bin/env python3
"""
Script pour générer automatiquement les versions refactorisées
de toutes les pages List basées sur le template de CitiesList
"""

# Template pour HotelsList
hotels_template = '''import React, { useMemo } from 'react'
...
print("✅ HotelsList template créé")

# Sauvegarder dans le fichier
with open('src/pages/hotels/HotelsList.tsx', 'w') as f:
    f.write(hotels_template)

print("✅ HotelsList.tsx écrit avec succès !")
