...
export default function ReviewsList() {
  ...
  if (error) return (
    <div className="px-8 py-6">
      <PageHeader title="Avis et Commentaires" icon="⭐" />
    ...
    <div className="px-8 py-6">
      ...
      {filteredReviews.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">None avis trouvé</h3>
          <p className="text-gray-600">Les avis des utilisateurs apparaîtront ici.</p>
        </div>
      ) : (
