 ...
 * Design épuré avec filtres slide pour gérer facilement les traductions
 */
export default function TranslationsList() {
  ...
  const filteredData = useMemo(() => {
    return flattenedData.filter(row => {
      ...
      // Filtre par langue (vérifie si la langue sélectionnée a du contenu)
  ...
  return (
    <div className="px-8 py-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Gérez toutes les traductions de votre application</p>
      </div>
