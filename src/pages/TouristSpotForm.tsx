...
export default function TouristSpotForm(){
  ...
  async function loadCities(){
    try {
      ...
      // getAdminCities returns axios.data; normalize to array regardless of envelope
      const responseData: any = res
      const citiesArr = Array.isArray(responseData?.data)
        ? responseData.data
        : (Array.isArray(responseData) ? responseData : [])
      setCities(citiesArr)
    } catch (e: any) {
  ...
  async function loadSpot(){
    try {
      ...
      if (spot) {
        ...
        // Ensure cityId is a string so the <select> matches option values
        // Admin GET may return either cityId or a city object; support both
        ...
        // Ensure controlled inputs: default missing owner/altText to empty string
